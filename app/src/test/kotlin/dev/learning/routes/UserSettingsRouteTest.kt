...
class UserSettingsRouteTest {
  ...
  fun `GET settings should return 401 without valid token`() = testApplication {
    ...
    // Act
    val response = client.get("/users/settings")
  ...
  fun `PUT settings should return 401 without valid token`() = testApplication {
    ...
    // Act
    val response = client.put("/users/settings") {
  ...
  fun `PUT settings should update dark mode successfully`() = testApplication {
    ...
    val getResponse = client.get("/users/settings") {
      header(HttpHeaders.Authorization, JWTTestHelper.createTestJWT(config))
    }
  ...
  fun `complete onboarding flow should progress through all phases correctly`() = testApplication {
    ...
    val initialResponse = client.get("/users/settings") {
    ...
    val nativeResponse = client.put("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
      header(HttpHeaders.ContentType, ContentType.Application.Json)
    ...
    val phase2Response = client.get("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
    }
    ...
    val completeResponse = client.put("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
      header(HttpHeaders.ContentType, ContentType.Application.Json)
    ...
    val finalResponse = client.get("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
    }
    ...
    val postOnboardingResponse = client.put("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
      header(HttpHeaders.ContentType, ContentType.Application.Json)
    ...
    val postOnboardingGetResponse = client.get("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
    }
  ...
  fun `onboarding should not allow completion without both languages set`() = testApplication {
    ...
    val prematureResponse = client.put("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
      header(HttpHeaders.ContentType, ContentType.Application.Json)
    ...
    val checkResponse = client.get("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
    }
  ...
  fun `onboarding should validate phase values`() = testApplication {
    ...
    val invalidResponse = client.put("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
      header(HttpHeaders.ContentType, ContentType.Application.Json)
  ...
  fun `onboarding flow should handle language conflicts during target language selection`() = testApplication {
    ...
    val step1Response = client.put("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
      header(HttpHeaders.ContentType, ContentType.Application.Json)
    ...
    val afterStep1 = client.get("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
    }
    ...
    val step2Response = client.put("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
      header(HttpHeaders.ContentType, ContentType.Application.Json)
    ...
    val afterStep2 = client.get("/users/settings") {
      header(HttpHeaders.Authorization, userJWT)
    }
